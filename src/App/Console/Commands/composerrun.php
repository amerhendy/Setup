...
class composerrun extends Command
{
     ...
     * @var string
     */
    protected $signature = 'Amer:composerrun {type}
    ...
    public function handle()
    {
        ...
        $process = new Process(['composer','require','predis/predis']);
        //export('HOME=/home/username');
        $process->setWorkingDirectory(base_path());
        $process->setEnv(['COMPOSER_HOME'=>'C:\laragon\bin\composer\composer\composer.phar']);
        $process->mustRun();
        echo $process->getOutput();
        dd($this->input->getArgument('type'));
